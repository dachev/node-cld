...
function detect (text, options, cb) {
...
function detectSync (text, options) {
  if (arguments.length < 2) {
    options = {};
  }
  if (!_.isString(text) || text.length < 1) {
  ...
  if (!_.isBoolean(options.isHTML)) {
    return {
      "success" : false,
      "error" : 'Invalid isHTML value'
    }
  }
  if (!_.isString(options.languageHint)) {
    return {
      "success" : false,
      "error" : 'Invalid languageHint'
    }
  }
  if (!_.isString(options.encodingHint)) {
    return {
      "success": false,
      "error" : 'Invalid encodingHint'
    }
  }
  if (!_.isString(options.tldHint)) {
    return {
      "success": false,
      "error" : 'Invalid tldHint'
    }
  }
  if (!_.isString(options.httpHint)) {
    return {
      "success": false,
      "error" : 'Invalid httpHint'
    }
  }
  if (options.encodingHint.length > 0 &&
    !~cld2.ENCODINGS.indexOf(options.encodingHint)) {
    ...
    return {
      "success": false,
      "error" : 'Invalid encodingHint, see ENCODINGS'
    }
  }
  if (options.languageHint.length > 0 &&
    !~_.keys(cld2.LANGUAGES).indexOf(options.languageHint) &&
    ...
    return {
      "success": false,
      "error" : 'Invalid languageHint, see LANGUAGES'
    }
  }
